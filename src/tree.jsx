function Tree(){
    return <div>
        ...
        <div className="sendgifts">
            <div className="text-container">
            <p>Please your friends</p>
            <h2>Send gifts and <br />order for groups</h2>
            <span>Send Gifts with a value for your friends and family and use it on their favorite stores. Be the rock star make Group Orders and pick up for your coworkers when they can't get away.</span>
            <div className="box"></div>
            </div>
            <div className="background"></div>
